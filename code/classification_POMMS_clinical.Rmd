...
sample_labels = p_ps@sam_data%>%
  ...
  as_tibble(rownames = NA) %>%
  rownames_to_column("sample") %>%
  select(sample, bmi, alt, crp= c_reactive_protein, cholestrol = total_chol, triglyceride, hdl, ldl, insulin, glucose, hba1c, homa_ir)

list = c("bmi", "alt", "crp", "cholestrol", "triglyceride", "hdl", "ldl", "insulin", "glucose", "hba1c", "homa_ir")
...
```{r}
label_list = c("bmi", "alt", "crp", "cholestrol", "triglyceride", "hdl", "ldl", "insulin", "glucose", "hba1c", "homa_ir", "bmi_shuffled", "alt_shuffled", "crp_shuffled", "cholestrol_shuffled", "triglyceride_shuffled", "hdl_shuffled", "ldl_shuffled", "insulin_shuffled", "glucose_shuffled", "hba1c_shuffled", "homa_ir_shuffled")
...
write_csv(results, "/Users/aa370/Library/CloudStorage/Box-Box/project_davidlab/LAD_LAB_Personnel/Ammara_A/Projects/POMMS/R24_POMMS/outputs/Figures/clinical_predictions_100iterations.csv")
```

# Plotting

The results very poor, unclear why this is.
## AUC plot and t-test
```{r}
results %>%
  pivot_longer(cols = bmi:homa_ir_shuffled, names_to = "variable", values_to = "pearson_corr") %>%
...
ggsave("/Users/aa370/Library/CloudStorage/Box-Box/project_davidlab/LAD_LAB_Personnel/Ammara_A/Projects/POMMS/R24_POMMS/outputs/Figures/clinical_predictions_100iterations.png", width =12)
```
