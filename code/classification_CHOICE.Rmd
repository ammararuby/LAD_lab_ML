...
```{r}
c_ps = readRDS("/Users/aa370/Library/CloudStorage/Box-Box/project_davidlab/LAD_LAB_Personnel/Ammara_A/Projects/CHOICE/CHOICE_Trnl/CHOICE_20220912/ps_objects/choice_complete_2022122.rds")
...
Preprocessing reduces column number to 126 from 500
...
sample_data(c_ps) %>%
  ...
  ggplot() +
  geom_boxplot(aes(x= treatment, y = bmi))+
  theme_classic()
